const translation = {
  ...
  CameraDisclosure: {
    ...
    ToContinueUsing: "Pour continuer à utiliser la fonction d'analyse de BC Wallet, veuillez autoriser les autorisations de caméra.",
    Allow: 'Autoriser',
  ...
  Error: {
    Title2020: "Impossible d'analyser l'invitation",
    Message2020: "Un problème est survenu lors de l'analyse de l'invitation à se connecter.",
    ...
    Title2026: "Oops! Quelque chose s'est mal passé",
  ...
  PersonCredential: {
    ...
    Name: 'Personne',
    Description:
      "Ajoutez vos justificatifs de personne à votre portefeuille pour prouver vos informations personnelles en ligne et accéder aux services en ligne.\n\nVous aurez besoin de l'application BC Service Card configurée sur cet appareil mobile.",
    LinkDescription: "Téléchargez l'application BC Services Card",
    GetCredential: "Téléchargez l'application BC Services Card",
    Decline: 'Obtenez ceci plus tard',
    PageTitle: "Justificatifs de la personne",
  },
  Screens: {
  ...
  Tips: {
    ...
    Tip2: "Contrairement à l'affichage de cartes physiques, vous ne partagez que ce qui est nécessaire à partir de vos justificatifs",
    Tip3: "Vos justificatifs sont stockés uniquement sur ce téléphone, nulle part ailleurs",
    Tip4: 'Les informations sont envoyées et reçues via une connexion cryptée introuvable',
    Tip5: "N'oubliez pas votre NIP. Si vous l'oubliez, vous devrez réinstaller et rajouter vos justificatifs",
    Tip6: "Ignorez le code PIN et déverrouillez votre portefeuille à l'aide de vos données biométriques pour une expérience plus rapide",
    ...
    Tip11: "Vous pouvez activer le flash de l'appareil photo si le code QR est difficile à voir",
